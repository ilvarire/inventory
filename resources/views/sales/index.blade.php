                ...
                return {
                    ...
                    async fetchSales() {
                        ...
                        try {
                            ...
                            if (this.filters.payment_method) params.append('payment_method', this.filters
                                .payment_method);
                            ...
                            // Calculate summary
                            this.summary.total_sales = this.sales.length;
                            this.summary.total_revenue = this.sales.reduce((sum, sale) => sum + parseFloat(sale
                                .total_amount || 0), 0);
                            this.summary.total_profit = this.sales.reduce((sum, sale) => sum + parseFloat(sale
                                .profit || 0), 0);
                        } catch (error) {
